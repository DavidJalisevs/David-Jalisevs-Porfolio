...
int main()
{
	...
	sf::RenderWindow window(sf::VideoMode(1440, 900), "Player Finite State Machine");
...
#pragma endregion
	...
	player.getAnimatedSprite().setPosition(500, 400);
	...
	while (window.isOpen())
	{
		...
		while (window.pollEvent(event))
		{
			...
			case sf::Event::KeyPressed:
				...
				{
					DEBUG_MSG("gpp::Events::Event::IDLE_CHECK_DAGGER_EVENT");
					input.setCurrent(gpp::Events::Event::CHECK_DAGGER_EVENT);
				}
				// Run Right
	...
	{
		player.getAnimatedSprite().move(0.5, 0);
	}
